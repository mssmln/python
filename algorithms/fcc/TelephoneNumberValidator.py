...
def telephoneCheck(string) :
    ...
    import re
    REGEX = re.compile(r'^1?\s?(\d{3})(-|\s)(\d{3})(-|\s)(\d{4})|^1?\s?\((\d{3})\)\s?(\d{3})-(\d{4})|^\d{10}$')
...
print(telephoneCheck("55 55-55-555-5")) # should return false.
print(telephoneCheck("11 555-555-5555")) # should return false.